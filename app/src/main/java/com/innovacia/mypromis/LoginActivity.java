...
public class LoginActivity extends AppCompatActivity  {
    ...
    private class checkUser extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String params) {
            ...
            if (sbResult == null)
            {
                Snackbar.make(coordinatorLayout, "Null!", Snackbar.LENGTH_LONG)
            ...
            if (sbResult.toString().equals("false")) {
                ...
                //Snackbar.make(coordinatorLayout, "User found!", Snackbar.LENGTH_LONG)
                //        .setAction("Action", null).show();
               ...
               // sb = new StringBuilder();
                ...
                startActivity(new Intent(LoginActivity.this, Project.class));
                finish();
