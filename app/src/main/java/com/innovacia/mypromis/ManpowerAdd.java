...
public class ManpowerAdd extends AppCompatActivity {

    String URL_ADD ="http://www.innovacia.com.my/promise/mobile/mobManpowerAdd.php";
    ...
    String strDate, strManDesig, strManUnit, strManCost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manpower_add);
        ...
        if(TextUtils.isEmpty(strProName)) {
            new AlertDialog.Builder(ManpowerAdd.this)
        ...
        fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(etDesc.getText())) {
                    ...
                    etDesc.requestFocus();
                    Snackbar.make(coordinatorLayout, "Fill in the Manpower Descriptions!", Snackbar.LENGTH_LONG)
        ...
        fabClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(ManpowerAdd.this, Manpower.class));
                finish();
    ...
    private class addMaterial extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            strManDesig =  etDesc.getText().toString();
            strManUnit =  etUnit.getText().toString();
            strManCost =  etCost.getText().toString();
            getDate();

            //TUNJUKKAN PROGRESS DIALOG
            pDialog = new ProgressDialog(ManpowerAdd.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                Uri.Builder builder = new Uri.Builder()
                        ...
                        .appendQueryParameter("siteManDate",strDate)
                        .appendQueryParameter("siteManDesig",strManDesig)
                        .appendQueryParameter("siteManUnit",strManUnit)
                        .appendQueryParameter("siteManCost", strManCost);
